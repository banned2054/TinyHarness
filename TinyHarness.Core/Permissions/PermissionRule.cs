...
/// scope. An empty <see cref="ScopePaths"/> means "any scope". A rule matches a
...
/// </summary>
internal sealed record PermissionRule(string Capability, IReadOnlyList<string> ScopePaths)
{
    /// <summary>
